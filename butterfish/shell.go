...
// the prompt context
const DEFAULT_AUTOSUGGEST_ENCODER = "gpt-4o-mini"
const DEFAULT_PROMPT_ENCODER = "gpt-4o-mini"
...
Please submit an issue to https://github.com/Rui-L/butterfish.`)
...
func (this *ButterfishCtx) SetPS1(childIn io.Writer) {
	...
	case "zsh":
		...
		ps1 = "PS1=$'%%{%s%%}'$PS1$'%s%%{ %%?%s%%} '\n"
	default:
		log.Printf("Unknown shell %s, Butterfish is going to leave the PS1 alone. This means that you won't get a custom prompt in Butterfish, and Butterfish won't be able to parse the exit code of the previous command, used for certain features. Create an issue at https://github.com/Rui-L/butterfish.", shell)
		return
	}
